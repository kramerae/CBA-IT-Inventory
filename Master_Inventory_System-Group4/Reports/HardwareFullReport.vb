...
Public Class HardwareFullReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Master_Inventory_System_Group4.HardwareFullReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHardwareFullReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HardwareFullReport = New HardwareFullReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
